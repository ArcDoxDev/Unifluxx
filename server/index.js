...
app.post('/api/request', (req, res, next) => {
  new Queue({sdk: sdk, user: req.user, project: req.body.project, source: req.body.source, dest: req.body.dest, notation: req.body.notation, classification: req.body.classification, credentials: req.session.credentials})
